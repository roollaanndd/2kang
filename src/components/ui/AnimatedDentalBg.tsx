...
const SHAPES_LG: Shape[] = [
  ...
  { x: 2, y: 8, s: 100, d: 1.6, t: 13, c: GOLD, o: 0.038, sh: 'ring' },
  { x: 78, y: 55, s: 28, d: 0.9, t: 9, c: PINK, o: 0.06, sh: 'plus' },
  { x: 4, y: 62, s: 68, d: 2.3, t: 17, c: PINK, o: 0.04, sh: 'tooth' },
  { x: 88, y: 72, s: 22, d: 1.2, t: 8, c: GOLD, o: 0.07, sh: 'sparkle' },
  { x: 50, y: 88, s: 72, d: 0.5, t: 12, c: PINK, o: 0.03, sh: 'ring' },
  { x: 94, y: 30, s: 22, d: 1.9, t: 10, c: GOLD, o: 0.06, sh: 'plus' },
  { x: 8, y: 30, s: 18, d: 0.3, t: 7, c: PINK, o: 0.08, sh: 'sparkle' },
  { x: 40, y: 3, s: 52, d: 3.2, t: 19, c: GOLD, o: 0.028, sh: 'tooth' },
  { x: 60, y: 10, s: 80, d: 2.6, t: 16, c: GOLD, o: 0.03, sh: 'ring' },
...
const SHAPES_SM: Shape[] = [
  ...
  { x: -4, y: 20, s: 56, d: 1.4, t: 10, c: GOLD, o: 0.05, sh: 'ring' },
  { x: 82, y: 55, s: 18, d: 0.7, t: 8, c: PINK, o: 0.07, sh: 'plus' },
  { x: 60, y: 78, s: 40, d: 2.1, t: 14, c: GOLD, o: 0.04, sh: 'ring' },
  { x: 8, y: 72, s: 14, d: 1.0, t: 7, c: GOLD, o: 0.08, sh: 'sparkle' },
